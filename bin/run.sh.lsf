...
FOLDER_NUMBER=1
CPU_NUMBER=1
bsub -G team238-grp -q cosmic -o ${LOG_FOLDER}/${JOB}.outfile.%J.%I -e ${LOG_FOLDER}/${JOB}.err.%J.%I -J ${JOB}[1-${FOLDER_NUMBER}]%${CPU_NUMBER} "${SINGULARITY_R_COR_HOME}/bin/prepare.sh"
